...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  // Select one random word for "Word of the Day" - consistent for both sides of card
    ...
    <div className='home'>
      ...
      <section className='home__hero'>
        ...
        <div className='home__card-preview'>
          <div className='home__card-front'>
            <div className='home__card-label'>Слово дня</div>
            <div className='home__card-term'>
              {wordOfDay?.term}
            </div>
            <div className='home__card-hint'>Наведите, чтобы увидеть перевод</div>
          </div>
          <div className='home__card-back'>
            <div className='home__card-translation'>
              {wordOfDay?.translation}
            </div>
            <div className='home__card-example'>
              {wordOfDay?.example || 'I eat an apple every morning'}
            </div>
          </div>
        </div>
      </section>
