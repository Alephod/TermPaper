    ...
    <div className='dictionary-page'>
      ...
      <section className='dictionary__list-section'>
        ...
        {filteredEntries.length === 0 ? (
          <div className='dictionary__empty-state'>
            <div className='dictionary__empty-icon'>📝</div>
            <h3>{dictionary.length === 0 ? 'Словарь пуст' : 'Нет слов по этому фильтру'}</h3>
            <p>
              {dictionary.length === 0
            ...
            {filteredEntries.map(entry => (
              <div key={entry.id} className='dictionary-entry'>
                ...
                {(entry.example || entry.exampleTranslation) && (
                  <div className='dictionary-entry__examples'>
                    {entry.example && (
                      <div className='dictionary-entry__example'>
                        <span className='dictionary-entry__example-label'>Пример:</span>
                        {entry.example}
                      </div>
                    )}
                    {entry.exampleTranslation && (
                      <div className='dictionary-entry__example-translation'>
                        {entry.exampleTranslation}
                      </div>
                    )}
                  </div>
                ...
                <div className='dictionary-entry__actions'>
                  <Button
                    variant='secondary'
                    size='sm'
